    ...
    <FooterContainer>
      <FooterWrapper>
        ...
        <SocialMediaIcons>
          ...
          <SocialMediaIcon href={Bio.twitter} target="_blank" aria-label="Twitter profile"><TwitterIcon /></SocialMediaIcon>
          <SocialMediaIcon href={Bio.github} target="_blank" aria-label="Github profile"><GitHubIcon /></SocialMediaIcon>
        </SocialMediaIcons>
        <Copyright>
          &copy; 2024 Azaz. All rights reserved.
        </Copyright>
      </FooterWrapper>
    </FooterContainer>
  );
